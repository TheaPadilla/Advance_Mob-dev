  ...
  return (
    <ScrollView style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.form}>
        ...
        <View style={styles.genreRow}>
          {genres.map((g) => (
            <TouchableOpacity
              ...
              style={[
                styles.genreOption,
                { backgroundColor: genre === g ? accentColor : colors.card },
              ]}
              onPress={() => {
                setGenre(g);
                validate("genre", g);
            ...
            >
              <Text
                style={[
                  styles.genreText,
                  {
                    color: genre === g ? colors.background : colors.text,
        ...
        {success && (
          <Animated.Text entering={FadeIn} style={{ color: "lime", fontSize: 14, marginTop: 8 }}>
            {success}
          </Animated.Text>
        )}
      </View>
